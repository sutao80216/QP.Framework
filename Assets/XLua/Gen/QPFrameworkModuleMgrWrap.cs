...
namespace XLua.CSObjectWrap
{
    ...
    public class QPFrameworkModuleMgrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(QP.Framework.ModuleMgr);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					QP.Framework.ModuleMgr gen_ret = new QP.Framework.ModuleMgr();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to QP.Framework.ModuleMgr constructor!");
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, QP.Framework.ModuleMgr.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
