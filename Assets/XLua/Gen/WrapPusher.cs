...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        int QPFrameworkShowType_TypeID = -1;
		int QPFrameworkShowType_EnumRef = -1;
        
        public void PushQPFrameworkShowType(RealStatePtr L, QP.Framework.ShowType val)
        {
            if (QPFrameworkShowType_TypeID == -1)
            {
			    bool is_first;
                QPFrameworkShowType_TypeID = getTypeId(L, typeof(QP.Framework.ShowType), out is_first);
				
				if (QPFrameworkShowType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(QP.Framework.ShowType));
				    QPFrameworkShowType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, QPFrameworkShowType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, QPFrameworkShowType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for QP.Framework.ShowType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, QPFrameworkShowType_EnumRef);
        ...
        public void Get(RealStatePtr L, int index, out QP.Framework.ShowType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != QPFrameworkShowType_TypeID)
				{
				    throw new Exception("invalid userdata for QP.Framework.ShowType");
				}
                ...
                {
                    throw new Exception("unpack fail for QP.Framework.ShowType");
                }
				val = (QP.Framework.ShowType)e;
                
            }
            else
            {
                val = (QP.Framework.ShowType)objectCasters.GetCaster(typeof(QP.Framework.ShowType))(L, index, null);
            }
        }
		
        public void UpdateQPFrameworkShowType(RealStatePtr L, int index, QP.Framework.ShowType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for QP.Framework.ShowType ,value="+val);
                }
            }
        ...
        public void PushQPFrameworkCanvasType(RealStatePtr L, QP.Framework.CanvasType val)
        {
            if (QPFrameworkCanvasType_TypeID == -1)
            {
			    bool is_first;
                QPFrameworkCanvasType_TypeID = getTypeId(L, typeof(QP.Framework.CanvasType), out is_first);
				
				if (QPFrameworkCanvasType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(QP.Framework.CanvasType));
				    QPFrameworkCanvasType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, QPFrameworkCanvasType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, QPFrameworkCanvasType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for QP.Framework.CanvasType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, QPFrameworkCanvasType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out QP.Framework.CanvasType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != QPFrameworkCanvasType_TypeID)
				{
				    throw new Exception("invalid userdata for QP.Framework.CanvasType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for QP.Framework.CanvasType");
                }
				val = (QP.Framework.CanvasType)e;
                
            }
            else
            {
                val = (QP.Framework.CanvasType)objectCasters.GetCaster(typeof(QP.Framework.CanvasType))(L, index, null);
            }
        }
		
        public void UpdateQPFrameworkCanvasType(RealStatePtr L, int index, QP.Framework.CanvasType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for QP.Framework.CanvasType ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(QP.Framework.CanvasType[]))
			{
				...
				translator.PushQPFrameworkCanvasType(L, array[index]);
				return true;
			}
